...
public class Item // #################
{
    ...
    public static Hashtable nameDataHashT = new Hashtable()
	{
		...
		{"인삼".GetHashCode(), new YinyangItem("인삼", "사실 인삼이나 산삼이나 거기서 거기다", ItemType.Solid, 5, null, false, new YinYang(0), "삼") },
		{"물".GetHashCode(), new YinyangItem("물", "물로 보지 말랜다", ItemType.Liquid,  5, null, false, new YinYang(0), "수")},
