...
public class Item : IComparable // #################
{
    ...
    public static Hashtable nameDataHashT = new Hashtable()
	{
		...
		{"인삼".GetHashCode(), new YinyangItem("인삼", "사실 인삼이나 산삼이나 거기서 거기다", ItemType.Solid, 5, null, false, new YinYang(0), DetailAmount.Empty, false, "삼") },
		{"물".GetHashCode(), new YinyangItem("물", "물로 보지 말랜다", ItemType.Liquid,  5, null, false, new YinYang(0), DetailAmount.Empty, false, "수")},
		...
		{"산삼".GetHashCode(), new YinyangItem("산삼", "심 봤 다", ItemType.Solid, 10, null, false, null, DetailAmount.Empty, false, "삼") },
		{"잘린 산삼".GetHashCode(), new YinyangItem("잘린 산삼", "손질 완료된 산삼이다.", ItemType.Solid, 10, null, false, null, DetailAmount.Empty, false, "삼") },
		{"녹제".GetHashCode(), new YinyangItem("녹제", "사슴의 발굽이다.", ItemType.Solid, 5, null, false, new YinYang(0), DetailAmount.Empty, false) },
		{"녹각".GetHashCode(), new YinyangItem("녹각", "사슴의 뿔이다.", ItemType.Solid, 5, null, false, new YinYang(0), DetailAmount.Empty, false) },
		{"녹용".GetHashCode(), new YinyangItem("녹용", "사슴의 뿔을 손질했다.", ItemType.Solid, 5, null, false, new YinYang(0), DetailAmount.Empty, false) },
		{"도약탕".GetHashCode(), new Medicines("도약탕", "다리의 힘을 비약적으로 상승시켜 땅을 박차고 공중으로 도약할 수 있게 해준다.", ItemType.Liquid, 1, null, false, new YinYang(0), DetailAmount.Empty) },
