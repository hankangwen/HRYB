...
public class StatusEffects
{
	...
	public StatusEffects()
	{
		...
		idStatEffPairs.Add(new StatusEffect("화상", "몸이 불탑니다.", StatEffApplyMethod.Stackable, OnFireActivated, OnFireUpdated, OnFireEnded), ((int)StatEffID.Fire));
	...
	void OnBleedingActivated(Actor self, Actor inflicter, float power)
	{
		...
		self.life.DamageYY(0, Mathf.Round(self.life.yy.white.Value * 0.004f), DamageType.DotDamage, -1, 1, null, DamageChannel.Bleeding);
	}
