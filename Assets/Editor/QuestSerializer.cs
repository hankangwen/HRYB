...
public class QuestSerializer : Editor
{
	...
	public const string OUTPUTFILENAME = "QuestCSV.csv";
	...
	{
		StreamWriter writer = new StreamWriter($"{Application.dataPath}{OUTPUTPATH}{OUTPUTFILENAME}", false, System.Text.Encoding.UTF8);
